    ...
    return _temp2 = _class = function (_Component) {
      ...
      _createClass(BlockResizeableDecorator, [{
        ...
        value: function render() {
          ...
          if (horizontal === "auto") {
            styles.width = "auto";
          } else if ((horizontal === "relative" || horizontal === "absolute") && (width || blockProps.resizeData.width)) {
            styles.width = '' + (width || blockProps.resizeData.width) + (horizontal === "relative" ? "%" : "px");
          }

          if (vertical === "auto") {
            styles.height = "auto";
          } else if ((vertical === "relative" || vertical === "absolute") && (height || blockProps.resizeData.height)) {
            styles.height = '' + (height || blockProps.resizeData.height) + (vertical === "relative" ? "%" : "px");
          }
